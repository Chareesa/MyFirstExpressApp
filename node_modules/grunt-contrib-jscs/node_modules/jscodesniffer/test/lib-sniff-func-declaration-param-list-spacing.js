...
var
		 ...
		 * @default
		 */
		TEST_SUITE_NAME = "FunctionDeclarationParameterListSpacing",
		/** @type {helper} */
    ...
    describe( "(cases)", function () {
      ...
      it("must trigger violation on function foo( a ) {}", function () {
        var caseId = "case1", tree = helper.getTree( caseId ), pNode;
          ...
          msg = mediator.getMessage( "FunctionDeclarationParamListPrecedingSpacing" );
          msg.should.be.ok;
        });
        ...
        var caseId = "case2", tree = helper.getTree( caseId ), pNode;
          ...
          pNode = tree.body[ 0 ];
          sniff.run( rule, pNode );
          msg = mediator.getMessage( "FunctionDeclarationParamListTrailingSpacing" );
          msg.should.be.ok;
        });
