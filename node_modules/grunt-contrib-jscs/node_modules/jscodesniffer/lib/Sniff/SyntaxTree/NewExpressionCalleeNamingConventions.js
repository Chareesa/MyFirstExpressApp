...
* @module lib/Sniff/SyntaxTree/NewExpressionCalleeNamingConventions
*/
...
var utils = require( "../Utils" ),
	...
	/**
	* @constructor
	* @alias module:lib/Sniff/SyntaxTree/NewExpressionCalleeNamingConventions
	* @param {module:lib/SourceCode} sourceCode
	* @param {module:lib/Mediator} mediator
	*/
	return function( sourceCode, mediator ) {
		/** @lends module:lib/Sniff/SyntaxTree/NewExpressionCalleeNamingConventions.prototype */
		return {
		/**
			* Check the contract
			* @access public
