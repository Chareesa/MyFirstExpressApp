...
* @module lib/Sniff/SyntaxTree/TernaryConditionalPunctuatorsSpacing
*/
...
var utils = require( "../Utils" ),
	...
	/**
	* @constructor
	* @alias module:lib/Sniff/SyntaxTree/TernaryConditionalPunctuatorsSpacing
	...
	*/
	Sniff = function( sourceCode, mediator, tokenIterator ) {
		...
		*/
		...
		/** @lends module:lib/Sniff/SyntaxTree/TernaryConditionalPunctuatorsSpacing.prototype */
		return {
			/**
			* Check the contract
			* @access public
